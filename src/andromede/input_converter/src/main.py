...
import os
from andromede.input_converter.src import __version__
import sys
...
def handle_env(config_parser) -> dict:
    ...
    config_env = {}
    for i, j in config_parser.items():
        for k, value in config_parser.items(i):
            env_name = i + "_" + k
...
if __name__ == "__main__":
    ...
    if args.conf:
        ...
        if not os.path.exists(args.conf):
            ...
            os.environ["CONFIG"] = str(os.path.abspath(args.conf))
