...
def test_generation_mps():
    ...
    study_path = "C:/Users/sonvicoleo/Documents/Test_finaux/BP23_FR_1week"
    ...
    thermal_var_secondary_up_on=thermal_var_reserves_on.loc[thermal_var_reserves_on["reserve_name"]=="secondary_up"]
    thermal_var_secondary_down_on=thermal_var_reserves_on.loc[thermal_var_reserves_on["reserve_name"]=="secondary_down"]
    ...
    reserve_cluster["secondary_up"] = {}
    reserve_cluster["secondary_down"] = {}
    ...
    list_cluster_enabled = []
    for thermal_cluster in list_thermal_clusters:
        [nom_noeud,nom_cluster] = thermal_cluster.split("_")
        if not(thermal_list[nom_noeud].has_option(nom_cluster,"enabled") and thermal_list[nom_noeud].get(nom_cluster,"enabled") == "false"):
            list_cluster_enabled.append(thermal_cluster)
    ...
    for thermal_cluster in list_cluster_enabled:
        ...
        if thermal_list[nom_noeud].has_option(nom_cluster,"min-stable-power"):
        ...
        if thermal_list[nom_noeud].has_option(nom_cluster,"marginal-cost"):
        ...
        if thermal_list[nom_noeud].has_option(nom_cluster,"startup-cost"):
        ...
        if thermal_list[nom_noeud].has_option(nom_cluster,"fixed-cost"):
            ...
            ensemble_valeurs[thermal_cluster]["fixed_cost"] =  [ 1 for t in range(168)]
        ...
        if reserves_areas_cost[nom_noeud].has_option('secondary_up','failure-cost'):
            ensemble_valeurs[thermal_cluster]["secondary_reserve_up_not_supplied_cost"] =  [ reserves_areas_cost[nom_noeud].getfloat('secondary_up','failure-cost') for t in range(168)]
        else:
            ensemble_valeurs[thermal_cluster]["secondary_reserve_up_not_supplied_cost"] = [ 0 for t in range(168)]
        if reserves_areas_cost[nom_noeud].has_option('secondary_up','spillage-cost'):
            ensemble_valeurs[thermal_cluster]["secondary_reserve_up_oversupplied_cost"] =  [ reserves_areas_cost[nom_noeud].getfloat('secondary_up','spillage-cost') for t in range(168)]
        else:
            ensemble_valeurs[thermal_cluster]["secondary_reserve_up_oversupplied_cost"] = [ 0 for t in range(168)]
        if reserves_areas_cost[nom_noeud].has_option('secondary_down','failure-cost'):
            ensemble_valeurs[thermal_cluster]["secondary_reserve_down_not_supplied_cost"] =  [ reserves_areas_cost[nom_noeud].getfloat('secondary_down','failure-cost') for t in range(168)]
        else:
            ensemble_valeurs[thermal_cluster]["secondary_reserve_down_not_supplied_cost"] = [ 0 for t in range(168)]
        if reserves_areas_cost[nom_noeud].has_option('secondary_down','spillage-cost'):
            ensemble_valeurs[thermal_cluster]["secondary_reserve_down_oversupplied_cost"] =  [ reserves_areas_cost[nom_noeud].getfloat('secondary_down','spillage-cost') for t in range(168)]
        else:
        ...
        if reserves_areas_cost[nom_noeud].has_option('tertiary2_up','failure-cost'):
        ...
        if reserves_areas_cost[nom_noeud].has_option('tertiary2_up','spillage-cost'):
        ...
        if reserves_areas_cost[nom_noeud].has_option('tertiary2_down','failure-cost'):
        ...
        if reserves_areas_cost[nom_noeud].has_option('tertiary2_down','spillage-cost'):
        ...
        if (nom_cluster in reserve_cluster["secondary_up"]) and ('max-power' in reserve_cluster["secondary_up"][nom_cluster]):
            ensemble_valeurs[thermal_cluster]["participation_max_secondary_reserve_up_on"] = [ reserve_cluster["secondary_up"][nom_cluster]['max-power'] for t in range(168)]
            ensemble_valeurs[thermal_cluster]["generation_reserve_up_secondary_on"] = list(thermal_var_secondary_up_on.loc[thermal_var_secondary_up_on["cluster_name"]==thermal_cluster]["sol"])
        else:
        ...
        if (nom_cluster in reserve_cluster["secondary_down"]) and ('max-power' in reserve_cluster["secondary_down"][nom_cluster]):
            ensemble_valeurs[thermal_cluster]["participation_max_secondary_reserve_down"] = [ reserve_cluster["secondary_down"][nom_cluster]['max-power'] for t in range(168)]
            ensemble_valeurs[thermal_cluster]["generation_reserve_down_secondary"] = list(thermal_var_secondary_down_on.loc[thermal_var_secondary_down_on["cluster_name"]==thermal_cluster]["sol"])
        ...
        if (nom_cluster in reserve_cluster["tertiary2_up"]) and ('max-power' in reserve_cluster["tertiary2_up"][nom_cluster]):
            ensemble_valeurs[thermal_cluster]["participation_max_tertiary2_reserve_up_on"] = [ reserve_cluster["tertiary2_up"][nom_cluster]['max-power'] for t in range(168)]
        ...
        if (nom_cluster in reserve_cluster["tertiary2_down"]) and ('max-power' in reserve_cluster["tertiary2_down"][nom_cluster]):
            ensemble_valeurs[thermal_cluster]["participation_max_tertiary2_reserve_down"] = [ reserve_cluster["tertiary2_down"][nom_cluster]['max-power'] for t in range(168)]
        ...
        ensemble_valeurs[thermal_cluster]["nb_units_max_invisible"] = [ thermal_list[nom_noeud].getint(nom_cluster,"unitcount") for t in range(168)]
