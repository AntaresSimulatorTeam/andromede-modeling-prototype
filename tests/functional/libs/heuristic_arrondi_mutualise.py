...
def arrondi_opti_entier_mutualise(
    version : str,
    nbr_on_float : float,
...
def determination_generations_mutulalise(
    nbr_on : int,
    nbr_off_primary : int,
    ...
    borne_min_off = (nbr_off_primary+nbr_off_secondary+nbr_off_tertiary1+nbr_off_tertiary2) * p_min
    ...
    solver.Add(1 * x + 1 * SPILL_x - 1 * za - 1 * SPILL_za - 1 * zb - 1 * SPILL_zb - 1 * zc - 1 * SPILL_zc - 1 * zd - 1 * SPILL_zd >= borne_min)
    solver.Add(1 * yaoff  + 1 * SPILL_yaoff + 1 * yboff  + 1 * SPILL_yboff + 1 * ycoff  + 1 * SPILL_ycoff + 1 * ydoff  + 1 * SPILL_ydoff <= borne_max_off)
    solver.Add(1 * yaoff  + 1 * SPILL_yaoff + 1 * yboff  + 1 * SPILL_yboff + 1 * ycoff  + 1 * SPILL_ycoff + 1 * ydoff  + 1 * SPILL_ydoff >= borne_min_off)
    solver.Add(1 * yaoff + 1 * SPILL_yaoff <= participation_max_primary_off)
    solver.Add(1 * yboff + 1 * SPILL_yboff <= participation_max_secondary_off)
    solver.Add(1 * ycoff + 1 * SPILL_ycoff <= participation_max_tertiary1_off)
    solver.Add(1 * ydoff + 1 * SPILL_ydoff <= participation_max_tertiary2_off)
...
def arrondi_eteint_mutualise(
    ...
    nbr_off_primary_float = dictionnaire_valeur["nb_off_primary"][t]
    nbr_off_secondary_float = dictionnaire_valeur["nb_off_secondary"][t]
    nbr_off_tertiary1_float = dictionnaire_valeur["nb_off_tertiary1"][t]
    nbr_off_tertiary2_float = dictionnaire_valeur["nb_off_tertiary2"][t]
    nbr_units_max = dictionnaire_valeur["nb_units_max_invisible"][t]
    ...
    if bonus == "reduction":
        result = determination_generations_mutulalise(nbr_on,nbr_off[0],nbr_off[1],nbr_off[2],nbr_off[3],dictionnaire_valeur,t)
        result_changement = [result[0] + 1,result[0] + 1,result[0] + 1,result[0] + 1]
        for i in range(4):
            if nbr_off[i] > 0:
                nbr_off[i] -= 1
                result_changement[i] = determination_generations_mutulalise(nbr_on,nbr_off[0],nbr_off[1],nbr_off[2],nbr_off[3],dictionnaire_valeur,t)
                nbr_off[i] += 1
...
def repartition_mutualise(
    ...
    [nbr_off_primary,nbr_off_secondary,nbr_off_tertiary1,nbr_off_tertiary2]  = arrondi_eteint_mutualise(bonus,option,nbr_on,dictionnaire_valeur,t)    
    [nbr_off_primary_classic,nbr_off_secondary_classic,nbr_off_tertiary1_classic,nbr_off_tertiary2_classic]  = arrondi_eteint_mutualise(bonus,option,nbr_on_classic,dictionnaire_valeur,t)

    result = determination_generations_mutulalise(nbr_on,nbr_off_primary,nbr_off_secondary,nbr_off_tertiary1,nbr_off_tertiary2,dictionnaire_valeur,t)
    result_classic = determination_generations_mutulalise(nbr_on,nbr_off_primary_classic,nbr_off_secondary_classic,nbr_off_tertiary1_classic,nbr_off_tertiary2_classic,dictionnaire_valeur,t)
    ...
    return [nbr_on_final,nbr_on,result[0],result_classic[0],startup_cost]
