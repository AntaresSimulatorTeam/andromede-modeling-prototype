...
THERMAL_CLUSTER_WITH_RESERVE_MODEL_MILP = model(
    ...
    constraints=[
        Constraint(
            "Max generation",
            var("energy_generation") + var("generation_reserve_up_primary_on") + var("generation_reserve_up_primary_off") 
            + var("generation_reserve_up_secondary_on") + var("generation_reserve_up_secondary_off")
            + var("generation_reserve_up_tertiary1_on") + var("generation_reserve_up_tertiary1_off") 
            + var("generation_reserve_up_tertiary2_on") + var("generation_reserve_up_tertiary2_off") <= param("max_generating"),
        ),
        Constraint(
            "Min generation",
        ...
        Constraint(
            ...
            <= param("participation_max_primary_reserve_up_off") * (param("nb_units_max_invisible") - var("nb_on")),
        ),
        Constraint(
        ...
        Constraint(
            ...
            <= param("participation_max_secondary_reserve_up_off") * (param("nb_units_max_invisible") - var("nb_on")),
        ),
        Constraint(
        ...
        Constraint(
            ...
            <= param("participation_max_tertiary1_reserve_up_off") * (param("nb_units_max_invisible") - var("nb_on")),
        ),
        Constraint(
        ...
        Constraint(
            ...
            <= param("participation_max_tertiary2_reserve_up_off") * (param("nb_units_max_invisible") - var("nb_on")),
        ),
        Constraint(
