...
def determination_generations_indep(
    nbr_on : int,
    nbr_off_primary : int,
...
def arrondi_eteint_indep(
    ...
    if option == "quantite":
        while (sum(nbr_off) * p_min > p_max * (nbr_units_max - nbr_on)) or ((sum(nbr_off) + nbr_on) * p_min > max_generating):
    ...
    if bonus == "reduction":
        result = determination_generations_indep(nbr_on,nbr_off[0],nbr_off[1],nbr_off[2],nbr_off[3],dictionnaire_valeur,t)

        result_changement = [result[0] + 1,result[0] + 1,result[0] + 1,result[0] + 1]
        for i in range(4):
            if nbr_off[i] > 0:
                nbr_off[i] -= 1
                result_changement[i] = determination_generations_indep(nbr_on,nbr_off[0],nbr_off[1],nbr_off[2],nbr_off[3],dictionnaire_valeur,t)[0]
                nbr_off[i] += 1
...
def repartition_indep(
    ...
    nbr_on = floor(round(nbr_on_float,12))
    [nbr_off_primary,nbr_off_secondary,nbr_off_tertiary1,nbr_off_tertiary2]  = arrondi_eteint_indep(bonus,option,nbr_on,dictionnaire_valeur,t)
 

    nbr_on_classic = ceil(round(nbr_on_float,12))
    [nbr_off_primary_classic,nbr_off_secondary_classic,nbr_off_tertiary1_classic,nbr_off_tertiary2_classic]  = arrondi_eteint_indep(bonus,option,nbr_on_classic,dictionnaire_valeur,t)

    result = determination_generations_indep(nbr_on,nbr_off_primary,nbr_off_secondary,nbr_off_tertiary1,nbr_off_tertiary2,dictionnaire_valeur,t)
    result_classic = determination_generations_indep(nbr_on_classic,nbr_off_primary_classic,nbr_off_secondary_classic,nbr_off_tertiary1_classic,nbr_off_tertiary2_classic,dictionnaire_valeur,t)
