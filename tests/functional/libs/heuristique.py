...
def heuristique_opti_entier(
    ...
    if version != "choix":
        arrondi_final = [ [arrondi_opti_entier(version,dictionnaire_valeur,t)] for t in horaire]
        return arrondi_final

    arrondi_base = [ arrondi_opti_entier("perte",dictionnaire_valeur,t) for t in range(horaire[0],horaire[len(horaire)-1])]
    arrondi_base.append(arrondi_opti_entier("sans",dictionnaire_valeur,t))
    arrondi_final = arrondi_base
    for t in range(horaire[1],len(horaire)-1):
        if arrondi_base[t-1] < arrondi_base[t] and arrondi_base[t] > arrondi_base[t+1]:
            arrondi_final[t] = arrondi_opti_entier("gain",dictionnaire_valeur,t)     
        elif arrondi_base[t-1] < arrondi_base[t] or arrondi_base[t] > arrondi_base[t+1]:
            arrondi_final[t] = arrondi_opti_entier("sans",dictionnaire_valeur,t)  
    if arrondi_base[horaire[0]] > arrondi_base[horaire[1]]:
        arrondi_final[horaire[0]] = [arrondi_opti_entier("sans",dictionnaire_valeur,t)]
    return arrondi_final
