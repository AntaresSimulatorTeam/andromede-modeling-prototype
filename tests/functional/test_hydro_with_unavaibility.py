...
@pytest.fixture
def optimal_generation() -> List[float]:
    return list(
        np.loadtxt(
            str(Path(__file__).parent)
            + "/data/hydro_with_unavailibility/optimal_generation.txt"
        )
    )


@pytest.fixture
def expected_monthly_generation() -> List[float]:
    return list(
        np.loadtxt(
            str(Path(__file__).parent)
...
@pytest.fixture
def expected_weekly_target() -> List[float]:
    return list(
        np.loadtxt(
            str(Path(__file__).parent)
